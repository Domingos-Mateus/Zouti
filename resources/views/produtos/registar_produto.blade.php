...
<div class="container mt-4">
    ...
    <form action="/salvar_produto" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome_produto" class="form-control" id="campo" placeholder="Produto">
          </div>
    <div class="form-group">
      <label for="campo">Preço:</label>
      <input type="text" name="preco" class="form-control" id="campo" placeholder="Preço">
    </div>
