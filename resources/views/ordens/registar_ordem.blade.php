...
<div class="container mt-4">
    ...
    <div class="form-group">
        ...
        <input type="number" name="quantidade_pedidos_cartao" class="form-control" id="campo" placeholder="20" required>
    </div>


    <div class="form-group">
        <label for="campo">Selecione o Gênero dos Clientes</label>
        <select name="genero_cliente" class="form-control" id="campo" required>
